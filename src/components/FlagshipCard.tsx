    ...
    >
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <button className="flex items-center gap-2 px-8 py-4 bg-white text-black rounded-full font-bold hover:bg-orange-500 hover:text-white transition-all group">
            View Live Project <ArrowRight className="group-hover:translate-x-1 transition-transform" />
          </button>
        </div>
